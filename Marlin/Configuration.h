 ...
 */
 ...
 //Creality SKR E3 Mini V3 Board Settings
  ...
  #define SKR_E3_MINI_V3_0
    #warning __FILE__ __LINE__ "Before MB ajs"
  #ifndef MOTHERBOARD
      #warning __FILE__ __LINE__ " Motheboard is ndef ajs"
    #if ENABLED(E3MINIV3_F4CPU)
    #warning __FILE__ __LINE__ " Vwer 3.0.1 ajs"
      #define MOTHERBOARD BOARD_BTT_SKR_MINI_E3_V3_0_1
    #else
     #warning __FILE__ __LINE__ " Motheboard is SKR E3 MINI V3 ajs"
